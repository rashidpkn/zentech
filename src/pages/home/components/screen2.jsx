    ...
    <section className='container mx-auto text-center lg:text-left'>
      <h2 className='text-center text-4xl py-5 font-medium text-[#47385e]'>Our Services</h2>
        <div className="grid lg:grid-cols-2 gap-5  px-5">
            <img src="/assets/img/home/web-development.webp"  className='rounded-lg max-h-[500px] h-full w-full object-cover object-top' alt="Zentech It Solutions Web Development" title="Zentech It Solutions Web Development" />
            ...
            <img src="/assets/img/home/seo.webp" className='rounded-lg max-h-[500px] h-full w-full object-cover object-top' alt="Zentech IT Solutions Search Engine Optimization" title="Zentech IT Solutions Search Engine Optimization" />


            <img src="/assets/img/home/local-seo.webp" className='rounded-lg max-h-[500px] h-full w-full object-cover object-top' alt="Zentech IT Solutions Search Engine Optimization" title="Zentech IT Solutions Search Engine Optimization" />
            <div className="flex flex-col justify-center items-center lg:items-start gap-5">
...
In the bustling town of Perinthalmanna, where businesses strive to stand out amidst fierce competition, finding the right branding agency is paramount. Look no further than Zentech IT Solutions, the beacon of innovation and creativity in the realm of branding.
            ...
            <img src="/assets/img/home/branding.webp" className='rounded-lg max-h-[500px] h-full w-full object-cover object-top' alt="Zentech IT Solutions Branding" title="Zentech IT Solutions Branding" />
